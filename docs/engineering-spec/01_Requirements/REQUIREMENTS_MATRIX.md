...
| FR-06 | 流式输出+实时渲染 (Markdown+语法高亮) | BIZ §Event Pipeline, API §WS Protocol, ARCH §Android/DetailScreen | `p0-android-prototype`, `p2-android-session-detail`, `p3-theme-and-animations`, `p3-session-detail-hardening`, `p3-initial-user-message-echo` | UT-06, E2E-07, PERF-04 | Phase 1-2 |

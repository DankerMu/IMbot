...
export type CompanionCommand = CreateSessionCommand | ResumeSessionCommand | SendMessageCommand | CancelSessionCommand | ListSessionsCommand | BrowseDirectoryCommand;
